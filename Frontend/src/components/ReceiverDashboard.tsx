/**
 * ReceiverDashboard - A comprehensive dashboard for managing receiver requests
 * 
 * Usage:
 * <ReceiverDashboard isApproved={true} />
 * <ReceiverDashboard isApproved={false} initialRequests={myRequests} />
 */
